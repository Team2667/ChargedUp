...
public final class Constants {
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = 5.451768; // FIXME Measure and set front left steer offset
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = 1.696583; // FIXME Measure and set front right steer offset
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = 1.382117; // FIXME Measure and set back left steer offset
    ...
    public static final int BACK_RIGHT_MODULE_STEER_ENCODER = 14;// FIXME Set back right steer encoder ID
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = 1.6873793465; // FIXME Measure and set back right steer offset
